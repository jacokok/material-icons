const synonyms = {
  ...
  AccessibilityNew:
    "accessible arms body handicap help human people person user",
  Accessible:
    "accessibility body handicap help human people person user wheelchair",
  AccessibleForward:
  ...
  AddComment:
    "+ bubble chat communicate feedback message new plus speech symbol",
  AddIcCall: "+ cell contact device hardware mobile new plus symbol telephone",
  AddLink: "attach clip new plus symbol",
  AddLocation:
    "+ destination direction gps maps new pin place plus stop symbol",
  ...
  AddTask:
    "+ approve check circle completed increase mark ok plus select tick yes",
  AddToDrive:
  ...
  AirlineSeatLegroomNormal:
    "body feet human people person sitting space travel",
  ...
  AlignHorizontalCenter:
    "alignment format layout lines paragraph rules style text",
  AlignHorizontalLeft:
    "alignment format layout lines paragraph rules style text",
  ...
  ArrowBackIos:
    "application chevron components direction interface left navigation previous screen ui ux website",
  ArrowBackIosNew:
    "application chevron components direction interface left navigation previous screen ui ux website",
  ...
  AssignmentInd:
    "account clipboard document face people person profile task user",
  AssignmentLate:
  ...
  BatteryChargingFull:
    "cell charge lightening lightning mobile power thunderbolt",
  ...
  Bloodtype:
    "donate droplet emergency hospital medicine negative positive water",
  ...
  Bookmark:
    "archive favorite follow label library reading remember ribbon save tag",
  ...
  Brightness4:
    "circle control crescent cresent dark level moon night screen sun",
  ...
  BugReport:
    "animal file fix insect issue problem testing ticket virus warning",
  ...
  CameraFront:
    "body human lens mobile person phone photography portrait selfie",
  CameraIndoor:
  ...
  CellWifi:
    "connection data internet mobile network phone service signal wireless",
  ...
  Check:
    "checkmark complete confirm correct done enter okay purchased select success tick yes",
  CheckBox:
  ...
  CircleNotifications:
    "active alarm alert bell chime notify reminder ring sound",
  Class:
  ...
  Clear:
    "allowed back cancel correct cross delete disable erase exit not times",
  ...
  Comment:
    "bubble chat communicate document feedback message note outline speech",
  CommentBank:
  ...
  Commute:
    "automobile car direction maps public train transportation trip vehicle",
  Compare:
  ...
  Copyright:
    "alphabet character circle emblem font legal letter owner symbol text",
  ...
  CropSquare:
    "adjustments area editing frame images photos rectangle settings size",
  ...
  DarkMode:
    "application device interface moon night silent theme ui ux website",
  ...
  DesignServices:
    "compose create draft editing input pencil ruler write writing",
  ...
  DirectionsBoatFilled:
    "automobile cars ferry maps public transportation vehicle",
  ...
  DirectionsRun:
    "body health human jogging maps people person route running walk",
  DirectionsSubway:
  ...
  DriveFileRenameOutline:
    "compose create draft editing input pencil write writing",
  ...
  EarbudsBattery:
    "accessory audio charging earphone headphone listen music sound",
  ...
  EmergencyShare:
    "alert attention caution danger important notification warning",
  ...
  EmojiNature:
    "animal bee daisy flower honey insect ladybug petals spring summer",
  ...
  FactCheck:
    "approve complete done list mark ok select tick validate verified yes",
  ...
  Filter:
    "editing effect image landscape mountains photography picture settings",
  Filter1:
  ...
  FilterTiltShift:
    "blur center editing effect focus images photography pictures",
  ...
  FlashOff:
    "camera disabled electric enabled fast lightning on slash thunderbolt",
  FlashOn:
    "camera disabled electric enabled fast lightning off slash thunderbolt",
  ...
  FlipCameraIos:
    "android editing front image mobile orientation rear reverse rotate turn",
  ...
  FolderZip:
    "compress data document drive file folders open sheet slide storage",
  ...
  FormatColorText:
    "doc editing editor fill paint spreadsheet style type writing",
  ...
  FormatLineSpacing:
    "alignment doc editing editor spreadsheet text type writing",
  FormatListBulleted:
  ...
  FullscreenExit:
    "adjust application components interface size ui ux view website",
  Functions:
  ...
  Garage:
    "automobile automotive cars direction maps transportation travel vehicle",
  ...
  GpsFixed:
    "destination direction location maps pin place pointer stop tracking",
  GpsNotFixed:
  ...
  Grade:
    "achievement important likes marked rated rating reward saved shape special star",
  Gradient: "color editing effect filter images photography pictures",
  Grading:
    "approve check complete document done feedback grade mark ok reviewed select tick validate verified writing yes",
  ...
  Healing:
    "bandage bandaid editing emergency fix health hospital image medicine",
  HealthAndSafety:
    "+ add certified plus privacy private protection security shield symbol verified",
  Hearing:
    "accessibility accessible aid handicap help impaired listen sound volume",
  HearingDisabled:
  ...
  HelpCenter:
    "? assistance information mark punctuation question support symbol",
  HelpOutline:
  ...
  HomeRepairService:
    "equipment fix kit mechanic repairing toolbox tools workshop",
  HomeWork:
  ...
  Label:
    "badge favorite indent item library mail remember save stamp sticker tag",
  LabelImportant:
  ...
  LaptopWindows:
    "Android chrome device display hardware iOS mac monitor screen web",
  LastPage:
  ...
  Layers:
    "arrange disabled enabled interaction maps off overlay pages slash stack",
  LayersClear:
  ...
  LinkedCamera:
    "connection lens network photography picture signals sync wireless",
  ...
  ListAlt:
    "box contained editor format lines reorder sheet stacked task title todo",
  LiveHelp:
  ...
  LocalHospital:
    "911 aid cross doctor emergency first health medical medicine plus",
  ...
  LocationSearching:
    "destination direction maps pin place pointer stop tracking",
  ...
  MarkChatUnread:
    "bubble circle comment communicate message notification speech",
  MarkEmailRead:
  ...
  Medication:
    "doctor drug emergency hospital medicine pharmacy pills prescription",
  MedicationLiquid:
  ...
  MoreVert:
    "3 android application components dots etc interface screen three ui ux vertical website",
  ...
  NightShelter:
    "architecture bed building estate homeless house place real sleep",
  NightsStay:
    "cloud crescent dark mode moon phases silence silent sky time weather",
  NineK:
  ...
  PersonOff:
    "account avatar disabled enabled face human people profile slash user",
  ...
  Pinch:
    "arrows compress direction finger grasp hand navigation nip squeeze tweak",
  ...
  PlayLesson:
    "audio bookmark digital ebook lesson multimedia play reading ribbon",
  ...
  RestartAlt:
    "around arrow inprogress loading reboot refresh renew repeat reset",
  Restaurant:
  ...
  RotateRight:
    "around arrow circle direction inprogress loading refresh renew turn",
  ...
  ScreenRotationAlt:
    "Android arrow device hardware iOS mobile phone rotate tablet turn",
  ScreenSearchDesktop:
    "Android arrow device hardware iOS lock monitor rotate web",
  ScreenShare:
  ...
  SecurityUpdate:
    "Android arrow device download hardware iOS mobile phone tablet",
  SecurityUpdateGood:
  ...
  Segment:
    "alignment fonts format lines list paragraph part piece rules style text",
  ...
  Settings:
    "application change details gear information options personal service",
  ...
  SettingsBluetooth:
    "connection connectivity device network signal symbol wifi",
  ...
  Share:
    "android connect contect link multimedia multiple network options send shared sharing social",
  ...
  SignalCellularAlt1Bar:
    "data internet mobile network phone speed wifi wireless",
  ...
  SignalCellularNodata:
    "internet mobile network offline phone quit wifi wireless x",
  SignalCellularNoSim:
  ...
  SixtyFpsSelect:
    "camera digits frame frequency numbers per rate seconds video",
  Skateboarding:
  ...
  SkipPrevious:
    "arrow backward controls forward music next play transport video",
  Sledding:
  ...
  SpeakerGroup:
    "audio box electronic loud multiple music sound stereo system video",
  SpeakerNotes:
  ...
  SportsSoccer:
    "athlete athletic entertainment exercise football game hobby social",
  SportsTennis:
  ...
  SquareFoot:
    "construction feet inches length measurement ruler school set tools",
  ...
  Stadium:
    "activity amphitheater arena coliseum event local star things ticket",
  ...
  StarOutline:
    "bookmark favorite half highlight ranking rate rating save toggle",
  StarPurple500:
    "best bookmark favorite highlight ranking rate rating save toggle",
  StarRate:
  ...
  StayPrimaryLandscape:
    "Android current device hardware iOS mobile phone tablet",
  StayPrimaryPortrait:
    "Android current device hardware iOS mobile phone tablet",
  ...
  TabUnselected:
    "browser computer documents folder internet tabs website windows",
  ...
  TextIncrease:
    "+ add alphabet character font letter new plus resize symbol type",
  ...
  Train:
    "automobile cars direction maps public rail subway transportation vehicle",
  ...
  TrendingFlat:
    "arrow change chart data graph metric movement rate right tracking",
  TrendingUp:
  ...
  TurnSlightLeft:
    "arrows directions maps navigation path right route sign traffic",
  TurnSlightRight:
    "arrows directions maps navigation path route sharp sign traffic",
  ...
  UTurnRight:
    "arrows directions maps navigation path route sign traffic u-turn",
  Vaccines:
  ...
  VideoFile:
    "camera document filming hardware image motion picture videography",
  VideogameAsset:
  ...
  ViewDay:
    "blocks calendar cards carousel design format grid layout website week",
  ...
  ViewList:
    "blocks design format grid layout lines reorder stacked title website",
  ViewModule:
  ...
  VpnKey:
    "login network passcode password register security signin signup unlock",
  VpnKeyOff:
    "[offline] disabled enabled network on passcode password slash unlock",
  VpnLock:
    "earth globe locked network password privacy private protection safety secure security virtual world",
  Vrpano:
    "angle image landscape mountains panorama photography picture view wide",
  ...
  WatchOff:
    "Android clock close gadget iOS shut time vr wearables web wristwatch",
  ...
  WbIncandescent:
    "balance bright editing lamp lightbulb lighting settings white wp",
